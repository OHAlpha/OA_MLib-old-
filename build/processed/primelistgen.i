unsigned int primes (unsigned long long int *arr,
		     unsigned long long int limit, unsigned int n);
unsigned int primesCont (unsigned long long int *arr,
			 unsigned long long int limit, unsigned int i,
			 unsigned int n);
