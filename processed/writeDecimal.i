     ...
     void writeDecimal (char *str, struct decimal arr)
{
  char *s;
  int r, c, i, j;
  s = (char *) malloc ((9 * (arr.length) + 2) * sizeof (char *));
  j = ((arr.length) > 0 && arr.integer[(arr.length) - 1] < 0) ? 1 : 0;
  for (i = arr.length - 1; i >= 0; i--)
    {
      c = arr.integer[i] & 0x3fffffff;
      s[j++] = (char) ('0' + ((c / 100000000) % 10));
      s[j++] = (char) ('0' + ((c / 10000000) % 10));
      s[j++] = (char) ('0' + ((c / 1000000) % 10));
      s[j++] = (char) ('0' + ((c / 100000) % 10));
      s[j++] = (char) ('0' + ((c / 10000) % 10));
      s[j++] = (char) ('0' + ((c / 1000) % 10));
      s[j++] = (char) ('0' + ((c / 100) % 10));
      s[j++] = (char) ('0' + ((c / 10) % 10));
      s[j++] = (char) ('0' + (c % 10));
    } s[j] = 0;
  ...
  if ((arr.length) > 0 && arr.integer[(arr.length) - 1] < 0)
    s[--j] = '-';
  for (i = j; i < 9 * (arr.length) + 2; i++)
    str[i - j] = s[i];
}

char *
strDecimal (struct decimal arr)
{
  char *s;
  int r, c, i, j;
  s = (char *) malloc ((9 * (arr.length) + 2) * sizeof (char *));
...
void
printDecimal (struct decimal arr)
{
  char *s;
  int r, c, i, j;
  s = (char *) malloc ((9 * (arr.length) + 2) * sizeof (char *));
