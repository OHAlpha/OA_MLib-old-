...
unsigned long long int lcmULL (unsigned long long int m,
			       unsigned long long int n);
...
unsigned short int
lcmUS (unsigned short int m, unsigned short int n)
{
...
unsigned int
lcmUI (unsigned int m, unsigned int n)
{
  unsigned int r;
  int p = m * n;
  while (1)
...
unsigned long int
lcmUL (unsigned long int m, unsigned long int n)
{
  unsigned long int r;
  int p = m * n;
  while (1)
...
long long int
lcmLL (long long int m, long long int n)
{
  long long int r;
  int p = m * n;
  while (1)
...
lcmULL (unsigned long long int m, unsigned long long int n)
{
