     ...
     int testReadDecimal (FILE * stream)
{
  ...
  a = readDecimal ("542572551564767856835714125465737");
  str = strDecimal (*a);
  ...
  a = readDecimal ("-6524769357236345753572612464547");
  str = strDecimal (*a);
