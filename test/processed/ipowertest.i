...
testIPowL (FILE * stream)
{
  ...
  p = ipowL (b, e);
  t = 1073741824;
  fprintf (stream, " * \t\tipow" "L" "( %" "ld" ", %" "ld" " ) = %" "ld" "\n",
	   b, e, p);
  if (p != t)
    {
      fprintf (stream,
...
testIPowD (FILE * stream)
{
  ...
  p = ipowD (b, e);
  t = 1073741824.;
  fprintf (stream, " * \t\tipow" "D" "( %" "lf" ", %" "ld" " ) = %" "lf" "\n",
	   b, e, p);
  if (p != t)
    {
      fprintf (stream,
