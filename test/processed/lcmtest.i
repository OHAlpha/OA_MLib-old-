...
testLcmLL (FILE * stream)
{
  ...
  d = lcmLL (m, n);
  t = m / 4 * n;
  fprintf (stream, " * \t\tlcm" "LL" "( %" "Ld" ", %" "Ld" " ) = %" "Ld" "\n",
	   m, n, d);
  if (d != t)
    {
      fprintf (stream,
