     ...
     int testProductInteger (FILE * stream)
{
  ...
  *((int *) b->integer) = 7362;
  ...
  fprintf (stream, " * \t%d * %d = %ld( %d )\n", 4623, 7362,
	   *((long *) c.integer), c.length);
  if (*((long *) c.integer) != 1l * 4623 * 7362)
    {
      fprintf (stream, " * \t\tFIXME: result should be %ld but is %d\n",
	       1l * 4623 * 7362, *((int *) c.integer));
      return 1;
    }
  *((int *) a->integer) = ((1 << 16) - 1);
  *((int *) b->integer) = ((1 << 16) - 1);
  productInteger (*a, *b, &c);
  fprintf (stream, " * \t%d * %d = %ld( %d )\n", ((1 << 16) - 1),
	   ((1 << 16) - 1), *((long *) c.integer), c.length);
  if (*((long *) c.integer) != 1l * ((1 << 16) - 1) * ((1 << 16) - 1))
    {
      fprintf (stream, " * \t\tFIXME: result should be %ld but is %d\n",
	       1l * ((1 << 16) - 1) * ((1 << 16) - 1), *((int *) c.integer));
      return 1;
    }
  *((int *) a->integer) = 1346;
  *((int *) b->integer) = 2463;
  ...
  fprintf (stream, " * \t%d * %d = %ld( %d )\n", 1346, 2463,
	   *((long *) c.integer), c.length);
  if (*((long *) c.integer) != 1l * 1346 * 2463)
    {
      fprintf (stream, " * \t\tFIXME: result should be %ld but is %d\n",
	       1l * 1346 * 2463, *((int *) c.integer));
      return 1;
    }
  *((int *) a->integer) = 1346;
  *((int *) b->integer) = -2463;
  ...
  *((int *) b->integer) = -1;
  ...
  fprintf (stream, " * \t%d * %d = %ld( %d )\n", 57275, -1,
	   *((long *) c.integer), c.length);
  if (*((long *) c.integer) != 1l * 57275 * -1)
    {
      fprintf (stream, " * \t\tFIXME: result should be %ld but is %d\n",
	       1l * 57275 * -1, *((int *) c.integer));
      return 1;
    }
  *((int *) a->integer) = 0;
  *((int *) b->integer) = -2367;
  ...
  fprintf (stream, " * \t%d * %d = %ld( %d )\n", 0, -2367,
	   *((long *) c.integer), c.length);
  if (*((long *) c.integer) != 1l * 0 * -2367)
    {
      fprintf (stream, " * \t\tFIXME: result should be %ld but is %d\n",
	       1l * 0 * -2367, *((int *) c.integer));
      return 1;
    }
  *((int *) a->integer) = 421;
  *((int *) b->integer) = -421;
  ...
  fprintf (stream, " * \t%d * %d = %ld( %d )\n", 421, -421,
	   *((long *) c.integer), c.length);
  if (*((long *) c.integer) != 1l * 421 * -421)
    {
      fprintf (stream, " * \t\tFIXME: result should be %ld but is %d\n",
	       1l * 421 * -421, *((int *) c.integer));
      return 1;
    }
  *((int *) a->integer) = -2462;
  *((int *) b->integer) = -6422;
  ...
  fprintf (stream, " * \t%d * %d = %ld( %d )\n", -2462, -6422,
	   *((long *) c.integer), c.length);
  if (*((long *) c.integer) != 1l * -2462 * -6422)
    {
      fprintf (stream, " * \t\tFIXME: result should be %ld but is %d\n",
	       1l * -2462 * -6422, *((int *) c.integer));
      return 1;
    }
