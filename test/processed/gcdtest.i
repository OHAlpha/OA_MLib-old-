...
testGcdC (FILE * stream)
{
  ...
  d = gcdC (m, n);
  t = 4;
  fprintf (stream, " * \t\tgcd" "C" "( %" "d" ", %" "d" " ) = %" "d" "\n", m,
	   n, d);
  if (d != t)
    {
      fprintf (stream,
	       " * \t\t\tFIXME: d should equal %" "d" " but instead is %" "d"
	       "\n", t, d);
      out |= 1;
    }
  m = 143;
...
testGcdL (FILE * stream)
{
  ...
  d = gcdL (m, n);
  t = 4;
  fprintf (stream, " * \t\tgcd" "L" "( %" "ld" ", %" "ld" " ) = %" "ld" "\n",
	   m, n, d);
  if (d != t)
    {
      fprintf (stream,
	       " * \t\t\tFIXME: d should equal %" "ld" " but instead is %"
	       "ld" "\n", t, d);
      out |= 1;
    }
  m = 243;
...
testGcdLL (FILE * stream)
{
  ...
  d = gcdLL (m, n);
  t = 4;
  fprintf (stream, " * \t\tgcd" "LL" "( %" "Ld" ", %" "Ld" " ) = %" "Ld" "\n",
	   m, n, d);
  if (d != t)
    {
      fprintf (stream,
