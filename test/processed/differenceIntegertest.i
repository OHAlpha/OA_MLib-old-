     ...
     int testDifferenceInteger (FILE * stream)
{
  ...
  *((int *) a.integer) = 4161436;
  *((int *) b.integer) = -1436116;
  differenceInteger (a, b, &c);
  fprintf (stream, " * \t%d + %d = %d ( %d )\n", 4161436, -1436116,
	   *((int *) c.integer), c.size);
  if (*((int *) c.integer) != 4161436 - -1436116)
    {
      fprintf (stream, " * \t\tFIXME: result should be %d but is %d\n",
	       4161436 - -1436116, *((int *) c.integer));
      return 1;
    }
  *((int *) a.integer) = 57275;
  *((int *) b.integer) = -1;
  ...
  fprintf (stream, " * \t%d + %d = %d ( %d )\n", 57275, -1,
	   *((int *) c.integer), c.size);
  if (*((int *) c.integer) != 57275 - -1)
    {
      fprintf (stream, " * \t\tFIXME: result should be %d but is %d\n",
	       57275 - -1, *((int *) c.integer));
      return 1;
    }
  *((int *) a.integer) = 0;
  *((int *) b.integer) = -2367;
  ...
  fprintf (stream, " * \t%d + %d = %d ( %d )\n", 0, -2367,
	   *((int *) c.integer), c.size);
  if (*((int *) c.integer) != 0 - -2367)
    {
      fprintf (stream, " * \t\tFIXME: result should be %d but is %d\n",
	       0 - -2367, *((int *) c.integer));
      return 1;
    }
  *((int *) a.integer) = 4161436;
  *((int *) b.integer) = 1436116;
  ...
  *((int *) b.integer) = -421;
  ...
  fprintf (stream, " * \t%d + %d = %d ( %d )\n", 421, -421,
	   *((int *) c.integer), c.size);
  if (*((int *) c.integer) != 421 - -421)
    {
      fprintf (stream, " * \t\tFIXME: result should be %d but is %d\n",
	       421 - -421, *((int *) c.integer));
      return 1;
    }
  *((int *) a.integer) = -43671547;
  *((int *) b.integer) = -5428522;
  differenceInteger (a, b, &c);
  fprintf (stream, " * \t%d + %d = %d ( %d )\n", -43671547, -5428522,
	   *((int *) c.integer), c.size);
  if (*((int *) c.integer) != -43671547 - -5428522)
    {
      fprintf (stream, " * \t\tFIXME: result should be %d but is %d\n",
	       -43671547 - -5428522, *((int *) c.integer));
      return 1;
    }
  free (a.integer);
  free (b.integer);
