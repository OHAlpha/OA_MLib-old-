     ...
     int testReadInteger (FILE * stream)
{
  ...
  struct integer *a;
  char *str;
  a = readInteger ("4161436");
  str = strInteger (*a);
  fprintf (stream, " * \t%s => %s\n", "4161436", str);
  if (!strEquals (str, "4161436"))
    {
  ...
  str = strInteger (*a);
  fprintf (stream, " * \t%s => %s\n", "421", str);
  if (!strEquals (str, "421"))
    {
      fprintf (stream, " * \t\tFIXME: result should be %s but is %s\n", "421",
	       str);
      return 1;
    }
  a = readInteger ("-43671547");
  str = strInteger (*a);
  fprintf (stream, " * \t%s => %s\n", "-43671547", str);
  if (!strEquals (str, "-43671547"))
    {
      fprintf (stream, " * \t\tFIXME: result should be %s but is %s\n",
	       "-43671547", str);
      return 1;
    }
  a = readInteger ("8796093022208");
  str = strInteger (*a);
  fprintf (stream, " * \t%s => %s\n", "8796093022208", str);
  ...
  a = readInteger ("542572551564767856835714125465737");
  str = strInteger (*a);
  fprintf (stream, " * \t%s => %s\n", "542572551564767856835714125465737",
	   str);
  if (!strEquals (str, "542572551564767856835714125465737"))
    {
      fprintf (stream, " * \t\tFIXME: result should be %s but is %s\n",
	       "542572551564767856835714125465737", str);
      return 1;
    }
  a = readInteger ("-6524769357236345753572612464547");
  str = strInteger (*a);
  fprintf (stream, " * \t%s => %s\n", "-6524769357236345753572612464547",
	   str);
  if (!strEquals (str, "-6524769357236345753572612464547"))
    {
      fprintf (stream, " * \t\tFIXME: result should be %s but is %s\n",
	       "-6524769357236345753572612464547", str);
      return 1;
    }
  fprintf (stream, " */");
  return out;
